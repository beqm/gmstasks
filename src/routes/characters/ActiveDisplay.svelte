...
{#if $ActiveStore.length > 0}
	{#if $ActiveStore[0].id == currentCharIteration.id}
		<div class="flex w-[33%] justify-center border-l-2 border-theme-focus">
			<svg class="w-[2rem] text-theme-base" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor"
	...
	{:else}
		<div class="flex w-[33%] justify-center">
			<svg
				class="w-[2rem] text-theme-base invisible"
